...
insert into freight_express(id, bill_code, shop_logistics_id, send_region_id, send_address, receiv_region_id, receiv_address,
                            send_name, receiv_name, send_mobile, receiv_mobile)
    value (1, '1234567890', 1, 10, 'test1', 12, 'test2',
      'name1', 'name2','17331111111','15366666666');
...
insert into freight_warehouse(address, id, shop_id, name, sender_name, creator_id, creator_name, gmt_create, region_id, sender_mobile, priority, invalid)
    value ('北京,东城,安定门,花园,安定北路14号', 26, 10, '花园仓库', '小玉', 1, 'admin', '2020-12-01 00:00:00', 43, '17331111111', 1000, 0);
