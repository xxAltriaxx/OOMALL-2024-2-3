...
public class UnAuthorizedController {
     ...
     */
    @GetMapping("/regions")
    public ReturnObject retriveRegionIdByName(@RequestParam String name){

        Region region=this.regionService.retriveRegionIdByName(name);
        IdNameTypeDto dto=IdNameTypeDto.builder().id(region.getId()).name(name).build();
        return new ReturnObject(dto);
    }
}
